package com.likwiik.lekha.adapter;
...
public class ContactAdapter extends RecyclerView.Adapter<ContactAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if((Integer) transaction_amount.get(position) >= 0){
            holder.transaction_amount_text.setText("+ "+ context.getResources().getString(R.string.currency_sign) + " " + String.valueOf(transaction_amount.get(position)));
         ...
         //   holder.transactionamountsymbol.setImageDrawable(context.getResources().getDrawable(R.drawable.credit_rs_symbol));
            ...
            holder.transaction_amount_text.setText("- "+ context.getResources().getString(R.string.currency_sign) + " " +String.valueOf(Math.abs((Integer) transaction_amount.get(position))));
