    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        see_all.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                getFragmentManager().beginTransaction().replace(R.id.frame_container, new TransactionFragment()).commit();
            }
        });
        ...
        debitbalance.setText("- "+ getResources().getString(R.string.currency_sign) + " " +debit_amount);
       // debit_amount_symbol.setImageDrawable(getResources().getDrawable(R.drawable.debit_rs_symbol));
        ...
        creditbalance.setText("+ "+getResources().getString(R.string.currency_sign) + " " +credit_amount);
        ...
        if((credit_amount - debit_amount) >=0 ){
            netbalance.setText("+ "+getResources().getString(R.string.currency_sign) + " " +Math.abs(credit_amount - debit_amount));
